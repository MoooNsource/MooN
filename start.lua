...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " باڤ"
SudosS = {2042257789,2042257789}
Sudos = {sudoid,2042257789,2042257789}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
JoinChannel = true
local url , res = https.request('https://api.telegram.org/bot5093643528:AAG0SCRmo7-6Q0WkjAnmJZphEHcnvLrDQfo/getchatmember?chat_id=@teampav&user_id='..msg.sender.user_id)
...
type = 'inline',
data = {
{{text = '⌔ 𝗍𝖾𝖺𝗆 : 𝗉𝖺𝗏',url="t.me/teampav"}},
}
}
...
{{text = '⌔ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "باڤ"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/Essensourse/uu/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/Essensourse/uu/main/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '⌁︙ 𝗍𝖾𝖺𝗆 : 𝗉𝖺𝗏', url = 't.me/teampav'}, },}}
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/teampav&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*⌔︙الساعه الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "باڤ"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "باڤ"),"اني لقميل "..(redis:get(bot_id..":namebot") or "باڤ"),(redis:get(bot_id..":namebot") or "باڤ").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "باڤ") then
...
local UserId_Info = bot.searchPublicChat("tttttx")
if UserId_Info.id then
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ 𝗉𝖺𝗏\n\n*[⌔  𝗉𝖺𝗏 ᴄʜᴀɴɴᴇʟ](http://t.me/teampav)*\n\n*[⌔  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/teampav)*\n\n*[⌔  𝗉𝖺𝗏 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/tttttx)*\n\n*[⌔  ʙᴏᴛ 𝗉𝖺𝗏](http://t.me/iE1BOT)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝗍𝖾𝖺𝗆 : 𝗉𝖺𝗏 ',url="t.me/teampav"}
...
if text == 'تيست' then 
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 't.me/teampav'}, },}}
return bot.sendText(msg.chat_id,msg.id,'*\n￤عذراً ، عليك الأشتراك في قناة البوت أولاً ،*',"md",false, false, false, false, reply_markup)
end
