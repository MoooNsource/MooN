...
JoinChannel = true
local url , res = https.request('https://api.telegram.org/bot5093643528:AAG0SCRmo7-6Q0WkjAnmJZphEHcnvLrDQfo/getchatmember?chat_id=@wwwuw&user_id='..msg.sender.user_id)
...
os.execute('curl -s https://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@raw.githubusercontent.com//MoooNsource/MooN/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com//MoooNsource/MooN/main/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
bot.sendText(msg.chat_id,msg.id,"*- اطلق دخول  : *"..Usertag..".","md")  
end
end
end
...
nameBot = {"ها حبي","نعم تفضل ؟","محتاج شي","عندي اسم  ترا","كلي سيد","ها فرجه","هاسيد","ها حبيبي","كول حياتي","هاااا فضني"}
...
data = {
{
{text = 'الغاء', data = msg.sender.user_id..'/MELONER'},
},
}
}
