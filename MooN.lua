...
return {
Lock     = '[𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂](https://t.me/MOOONTEAM)\n*— — — — — — — — —\n- بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n- خاصيه المسح *',
unLock   = '[𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂](https://t.me/MOOONTEAM)\n*— — — — — — — — —\n- بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂](https://t.me/MOOONTEAM)\n*— — — — — — — — —\n- بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n- خاصيه الكتم *',
lockKid  = '[𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂](https://t.me/MOOONTEAM)\n*— — — — — — — — —\n- بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n- خاصيه التقييد *',
lockKick = '[𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂](https://t.me/MOOONTEAM)\n*— — — — — — — — —\n- بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n- خاصيه الطرد *',
Reply    = '[𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂](https://t.me/MOOONTEAM)\n*— — — — — — — — —\n- المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂 ⁦', url='https://t.me/MOOONTEAM'},
},
}
}
...
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂', url = 't.me/MOOONTEAM'},
},
}
}
if not msg.ControllerBot then
...
local tt =[[
Welcome To Source
᥀︙[Source Dove](https://t.me/MOOONTEAM) .
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ Source Channel ›', url = "https://t.me/MOOONTEAM"}},
{{text = '‹ Developer', url = "https://t.me/HMMOT"},{text = 'Tws Dove ›', url = "https://t.me/GBJBOT"}},
{{text = '‹ Exp Source ›', url = "https://t.me/TTT33"}}
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/RR77FF&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == (Redis:get(TheMooN.."MooN:Name:Bot") or "حجي") then
local NamesBot = (Redis:get(TheMooN.."MooN:Name:Bot") or "حجي")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات حجي بعدين اجاوبك",
...
local CmdStart = '*\n- أهلآ بك في بوت '..(Redis:get(TheMooN.."MooN:Name:Bot") or "حجي")..
