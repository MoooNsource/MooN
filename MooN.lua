...
LuaTele.sendText(msg_chat_id,msg_id,[[- ارسل الرد وتستطيع استخدام .
( ملف - ملصق - متحركه - صوره
 - فيديو - بصمه الفيديو - بصمه - صوت - رساله )
- يمكنك اضافة الى النص .
— — — — — — — — —
...
local Texting = {'ملاك وناسيك بكروبنه??',"حلغوم والله ","اطلق صوره","كيكك والله","لازك بيها غيرها عاد",}
...
data = {
{
{text = '- قناة السورس', url = 't.me/MoooNteam'}, 
},
}
}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/HMMOT"}
},
{
{text = '������ ���� ☾ .', url = "https://t.me/MoooNteam"},
},
...
if photo.total_count > 0 then
local TestText = "- name Dev :["..UserInfo.first_name.."](tg://user?id="..Sudo_Id..")\n- Bio Dev : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '������ ���� ☾ .', url = "https://t.me/MoooNteam"}
...
if text == 'السورس' or text == 'سورس' or text == '— — — — — — — — —'  then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗢𝗢𝗡 ☾ ', url = 't.me/MoooNteam'}, 
},
{
...
LuaTele.answerCallbackQuery(data.id, "- تم رفعه {"..y.."} ادمنيه \n- تم رفعه المالك ", true)
end
end
