...
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗆𝗈𝗈𝗇 ⁦', url='https://t.me/MoooNteam'},
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'.عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheMooN..'MooN:Num:Add:Bot'),"md",true)  
end
...
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗆𝗈𝗈𝗇', url = 't.me/MoooNteam'},
},
}
}
if not msg.ControllerBot then
...
if photo.total_count > 0 then
local TestText = " - Ahmed Mohammed.\n .*account* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n.*Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗆𝗈𝗈𝗇', url = "https://t.me/MoooNteam"}
...
return LuaTele.sendText(msg_chat_id,msg_id,'.عليك استخدام الازرار الشفافه للتحكم ',"md",false, false, false, false, reply_markup)
elseif text == 'م3' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*: هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
...
if text == (Redis:get(TheMooN.."MooN:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(TheMooN.."MooN:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'ردد','حذف رد')
...
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'ري','ريمكس')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'ش','شعر')
...
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'تاك','تاك للكل')
...
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس',' مسح رسائلي')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،',' مسح المكتومين ')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'مدد','  مسح المدراء')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'مم',' مسح المميزين')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'منن',' مسح المنشئين')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'ادد',' مسح الادمنيه')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'ت','  تثبيت')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'مطط',' مسح المطورين')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'تق',' تقيد ')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'تقق',' مسح المقيدين')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفعع','  تفعيل الترحيب')
Redis:set(TheMooN.."MooN:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعطط','  تعطيل الترحيب')
...
local CmdStart = '*\n.أهلآ بك في بوت '..(Redis:get(TheMooN.."MooN:Name:Bot") or "بلاك بينك")..
