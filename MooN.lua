...
data = {
{
{text = 'Channel Source ،', url = 't.me/MOOONTEAM'}, 
},
{
{text = 'Annotations Source', url = 't.me/TTT33'}, 
},
{
{text = 'Communication Source', url = 't.me/GBJBOT'}, 
},
{
{text = 'Developer Source !', url = 't.me/HMMOT'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
