...
data = {
{
{text = 'تغير الرد', data = msg.sender.user_id..'/chengreplyg'},
},
{
...
data = {
{
{text = 'تغير الرد', data = msg.sender.user_id..'/chengreplys'},
},
{
{text = 'الغاء', data = msg.sender.user_id..'/delamrredis'},
},
...
Redis:del(TheMooN.."MooN:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMooN.."MooN:Game:Estimate"..msg.chat_id..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- اهه لقد خسرت في اللعبه \n- حظآ اوفر في المره القادمه \n- كان الرقم الذي تم تخمينه { "..GETNUM.." }","md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"- اهه تخمينك غلط \n- ارسل رقم تخمنه مره اخرى ","md",true)  
end
end
end
end
...
data = {
{
{text = 'تغير الرد', data = msg.sender.user_id..'/chengreplygg'},
},
{
{text = 'الغاء', data = msg.sender.user_id..'/delamrredis'},
},
...
if text == "متحركات تمبلر" or text == "متحركه تمبلر" then
Abs = math.random(2,140); 
local Text ='*تدلل حوبي *'
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/temblrmoon/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "شعر" then
Abs = math.random(2,140); 
local Text ='*مليان احساس مليان*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘮𝘰𝘰𝘯 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/MOOONTEAM"}},
}
...
if text == "متحركه اطفال" or text == 'اطفال' or text == 'متحركات اطفال' then
Abs = math.random(2,140); 
local Text ='*😫💞*'
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/Childrenmooon/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'سورسك' then
...
data = {
{
{text = '𝘮𝘰𝘰𝘯 𝘴𝘰𝘶𝘳𝘤𝘦 .𝘤𝘦 .', url = 't.me/MOOONTEAM'}, 
},
}
}
...
data = {
{
{text = '  بصمه ', data = 'oggidu@'..IdUser..'idv@'..listYt[3]}, 
},
{
{text = '  ملف صوتي ', data = 'mp3idu@'..IdUser..'idv@'..listYt[3]},  {text = '  فيديو ', data = 'mp4idu@'..IdUser..'idv@'..listYt[3]}, 
},
{
...
io.popen('curl -s "https://black-source.xyz/BlackTeAM/searchinbot.php?token='..listYt[2]..'&token='..Token..'&chat='..ChatId..'&type=ogg&msg=0"')
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen('curl -s "https://black-source.xyz/BlackTeAM/searchinbot.php?token='..listYt[2]..'&token='..Token..'&chat='..ChatId..'&type=mp3&msg=0"')
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen('curl -s "https://black-source.xyz/BlackTeAM/searchinbot.php?token='..listYt[2]..'&token='..Token..'&chat='..ChatId..'&type=mp4&msg=0"')
end
end
...
{
{text = 'مره اخرى ', data = '/MahibesAgane'},
},
}
}
