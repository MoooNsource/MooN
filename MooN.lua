------------------------------------------------
-- This Source Was Developed By (MooN) @oo6oo.--
--   This Is The Source Channel @oo6oo .   --
--                - 𝗦𝗼𝘂𝗿𝗰𝗲 MooN-                 --
--        -- https://t.me/oo6oo --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,370987883}  
...
if UserId == 370987883 then
Status = true
elseif UserId == 370987883 then
Status = true
...
if tonumber(msg.sender.user_id) == 370987883 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 370987883 then
...
{{text =news,url = "https://t.me/wwwuw"}, },}}
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 MooN', url='https://t.me/wwwuw'},
},
}
}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/wwwuw'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n -  عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if text == "بصمات مناوهيج" then
  ...
  keyboard = {} 
  keyboard.inline_keyboard = {{{text = 'بصمه ثانيه ', callback_data = msg.sender.user_id..'/Song'}},{{text='MNH',url="t.me/wwwuw"}
  }
  }
  local msg_id = msg.id/2097152/0.5
  https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/mnhvoise/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
if text == "متحركه" then
Abs = math.random(2,140); 
...
local UserId_Info = LuaTele.searchPublicChat("oo6oo")
...
if photo.total_count > 0 then
local TestText = "- مطور السورس ."
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝒂𝒍𝒊 𝒂𝒍-𝒔𝒉𝒂𝒎𝒎𝒂𝒓𝒊 ☬', url = "https://t.me/oo6oo"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
local TestText = "- مبرمج السورس ."
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝒂𝒍𝒊 𝒂𝒍-𝒔𝒉𝒂𝒎𝒎𝒂𝒓𝒊 ☬', url = "https://t.me/oo6oo"}
...
if text == "مناوهيج" or text == 'منا وهيج' then
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'سورسك' then
  photo = "https://t.me/PicturMNH/3"
  local T =[[
    𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘵𝘩𝘦 𝘮𝘯𝘩 𝘴𝘰𝘶𝘳𝘤𝘦 .
   ]]
  keyboard = {} 
  keyboard.inline_keyboard = {
  {
  {text = '𝘮𝘯𝘩 𝘴𝘰𝘶𝘳𝘤𝘦 . ', url = "https://t.me/wwwuw"}}}
  local msgg = msg_id/2097152/0.5
...
if text == (Redis:get(TheMooN.."MooN:Name:Bot") or "مناوهيج") then
local NamesBot = (Redis:get(TheMooN.."MooN:Name:Bot") or "مناوهيج")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"كلي سيد",
"هاسيد",
"ولكحاب موجود",
"اخرس ياحيوان"..NamesBot,
'عير بطيزك شتريد'
}
...
local NamesBot = (Redis:get(TheMooN.."MooN:Name:Bot") or "مناوهيج")
local BotName = {
"ترا عندي اسم ابن الكحبه اسمي"..NamesBot,
"ابن العريضه اسمي "..NamesBot.. "",
"كلي بعدروحي"
}
...
"لو خيروك |  بين تناول الشوكولا التي تفضلها لكن مع إضافة رشة من الملح والقليل من عصير الليمناوهيج إليها أو تناول ليمناوهيجة كاملة كبيرة الحجم؟ ",
...
if Redis:get(TheMooN.."MooN:Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمناوهيج","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
...
name = string.gsub(name,"سلمناوهيج","ن م و ل س")
...
local CmdStart = '*\n- أهلآ بك في بوت '..(Redis:get(TheMooN.."MooN:Name:Bot") or "مناوهيج")..
...
data = {
{
{text = '-  السورس .', url = 't.me/wwwuw'},{text = '-  لتنصيب بوت .', url = 't.me/oo6oo'}, 
},
{
...
{
{text = 'العب مرى اخرى .', data = '/MahibesAgane'},
},
}
}
