...
if text == (Redis:get(TheMooN.."MooN:Name:Bot") or "جوكر") then
local NamesBot = (Redis:get(TheMooN.."MooN:Name:Bot") or "جوكر")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n- أهلآ بك في بوت '..(Redis:get(TheMooN.."MooN:Name:Bot") or "جوكر")..
